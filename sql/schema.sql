...
-- on the same request, sets listing to contracted, creates a
-- contact_reveal record, and notifies both parties.
-- Contact details are NOT revealed here — that happens when the
