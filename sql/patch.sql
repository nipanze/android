-- Patch to add test users for East African countries and sample posts
-- Password for all accounts: Test1234!

-- Insert additional auth users (Kenya, Tanzania, Rwanda, South Sudan, Burundi)
...
-- Provision corresponding profiles and subscriptions for the new users
...
-- Ensure a plain unique constraint exists on user_id so ON CONFLICT works
