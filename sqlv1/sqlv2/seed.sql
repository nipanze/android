...
--
-- HOW THIS WORKS:
--   1. INSERT into auth.users with FIXED UUIDs + confirmed emails
--      → handle_new_auth_user trigger fires automatically
--      → creates public.users row with same UUID + defaults
--      → trg_auto_create_wallet fires
--      → creates wallet_balances row
--
--   2. UPDATE public.users to set correct role, status,
--      phone_number, email_verified, etc. (trigger only sets defaults)
--
--   3. INSERT user_profiles, kyc_verifications, risk_assessments
--      using email-based lookups (UUIDs now guaranteed stable)
--
--   4. INSERT loan_requests, wallet deposits, bids, bid acceptance
--      (identical logic to original seed)
--
-- Password for ALL accounts: Test1234!
-- Hash: $2b$10$IXGSfHBcvEpctfKDXu6.7OH.UTPOu.f8lCMtOQ5Rf7HM3/7Ry9biO
--
...
-- ============================================
-- STEP 1: AUTH USERS
-- Insert into auth.users with fixed UUIDs and
-- confirmed emails. handle_new_auth_user trigger
-- fires automatically, creating public.users rows.
-- ============================================
...
-- At this point handle_new_auth_user has fired for each row above,
-- creating public.users rows with defaults:
--   role   = 'borrower'
--   status = 'pending_verification'
--   email_verified = FALSE
-- We now UPDATE to set the correct values.


-- ============================================
-- STEP 2: UPDATE public.users
-- Set role, status, phone, verification flags,
-- login history, and timestamps that the trigger
-- does not set.
-- ============================================
...
UPDATE users SET
    ...
    last_login_at         = '2026-01-28 14:22:00',
    last_login_ip         = '102.168.1.45',
    created_at            = '2024-01-15 08:30:00'
WHERE email = 'david.mukasa@gmail.com';
...
UPDATE users SET
    ...
    phone_verified        = TRUE,
    two_factor_enabled    = FALSE,
    last_login_at         = '2026-01-29 09:15:00',
    last_login_ip         = '102.168.1.67',
    created_at            = '2024-01-18 10:45:00'
WHERE email = 'sarah.namukasa@yahoo.com';
...
UPDATE users SET
    ...
    last_login_at         = '2026-01-27 16:40:00',
    last_login_ip         = '102.168.1.89',
...
UPDATE users SET
    ...
    phone_verified        = TRUE,
    two_factor_enabled    = FALSE,
    last_login_at         = '2026-01-28 11:30:00',
    last_login_ip         = '102.168.1.102',
    created_at            = '2024-01-22 09:10:00'
WHERE email = 'maria.nakato@gmail.com';
...
UPDATE users SET
    ...
    phone_verified        = TRUE,
    two_factor_enabled    = TRUE,
    last_login_at         = '2026-01-29 08:20:00',
    last_login_ip         = '102.168.1.125',
    created_at            = '2024-01-25 11:30:00'
WHERE email = 'robert.ssemwanga@gmail.com';
...
UPDATE users SET
    ...
    phone_verified        = TRUE,
    two_factor_enabled    = TRUE,
    last_login_at         = '2026-01-28 16:30:00',
    last_login_ip         = '102.168.2.10',
    created_at            = '2024-02-18 09:20:00'
WHERE email = 'info@greenleafagro.co.ug';
...
UPDATE users SET
    ...
    phone_verified        = TRUE,
    two_factor_enabled    = TRUE,
    last_login_at         = '2026-01-29 10:20:00',
    last_login_ip         = '102.168.2.20',
    created_at            = '2024-02-20 11:40:00'
WHERE email = 'contact@kampalatech.ug';

UPDATE users SET
    phone_number          = '+256716789012',
    role                  = 'lender',
    status                = 'active',
    email_verified        = TRUE,
    phone_verified        = TRUE,
    two_factor_enabled    = TRUE,
    last_login_at         = '2026-01-28 17:20:00',
    last_login_ip         = '102.168.2.30',
    created_at            = '2024-03-01 10:10:00'
WHERE email = 'invest@pearlcapital.ug';

UPDATE users SET
    phone_number          = '+256717890123',
    role                  = 'lender',
    status                = 'active',
    email_verified        = TRUE,
    phone_verified        = TRUE,
    two_factor_enabled    = TRUE,
    last_login_at         = '2026-01-29 08:50:00',
    last_login_ip         = '102.168.2.40',
    created_at            = '2024-03-03 12:30:00'
WHERE email = 'funds@victoriainvest.co.ug';

UPDATE users SET
    phone_number          = '+256718901234',
    role                  = 'lender',
    status                = 'active',
    email_verified        = TRUE,
    phone_verified        = TRUE,
    two_factor_enabled    = TRUE,
    last_login_at         = '2026-01-27 15:30:00',
    last_login_ip         = '102.168.2.50',
    created_at            = '2024-03-05 09:45:00'
WHERE email = 'lending@equatorfinance.ug';

UPDATE users SET
    phone_number          = '+256719012345',
    role                  = 'borrower',
    status                = 'active',
    email_verified        = TRUE,
    phone_verified        = TRUE,
    two_factor_enabled    = FALSE,
    last_login_at         = '2026-01-28 12:40:00',
    last_login_ip         = '102.168.3.10',
    created_at            = '2024-03-08 14:15:00'
WHERE email = 'frank.omondi@gmail.com';

UPDATE users SET
    phone_number          = '+256720123456',
    role                  = 'both',
    status                = 'active',
    email_verified        = TRUE,
    phone_verified        = TRUE,
    two_factor_enabled    = TRUE,
    last_login_at         = '2026-01-29 13:25:00',
    last_login_ip         = '102.168.3.20',
    created_at            = '2024-03-10 11:20:00'
WHERE email = 'lucy.nambi@yahoo.com';

UPDATE users SET
    phone_number          = '+256721234567',
    role                  = 'both',
    status                = 'active',
    email_verified        = TRUE,
    phone_verified        = TRUE,
    two_factor_enabled    = FALSE,
    last_login_at         = '2026-01-28 08:15:00',
    last_login_ip         = '102.168.3.30',
    created_at            = '2024-03-12 16:40:00'
WHERE email = 'charles.mwesigwa@gmail.com';

UPDATE users SET
    phone_number          = '+256726789012',
    role                  = 'borrower',
    status                = 'pending_verification',
    email_verified        = TRUE,
...
WHERE email = 'alice.namuli@gmail.com';
...
UPDATE users SET
    ...
    phone_verified        = TRUE,
    two_factor_enabled    = FALSE,
    last_login_at         = '2026-02-06 10:00:00',
...
SELECT gen_random_uuid(), u.user_id,
    720, 74.0, 'low', 78, 72, 22.5, 70,
    NULL, '2024-01-19 12:00:00', '2026-07-18', TRUE, '2024-01-19 12:00:00'
FROM users u WHERE u.email = 'sarah.namukasa@yahoo.com';
...
SELECT gen_random_uuid(), u.user_id,
    780, 88.0, 'low', 92, 85, 18.7, 87,
    NULL, '2024-01-21 09:00:00', '2026-07-20', TRUE, '2024-01-21 09:00:00'
FROM users u WHERE u.email = 'james.okello@outlook.com';
...
SELECT gen_random_uuid(), u.user_id,
    650, 61.0, 'medium', 65, 58, 35.0, 60,
    NULL, '2024-01-23 14:00:00', '2026-07-22', TRUE, '2024-01-23 14:00:00'
FROM users u WHERE u.email = 'maria.nakato@gmail.com';
...
SELECT gen_random_uuid(), u.user_id,
    790, 85.0, 'low', 90, 88, 12.0, 85,
    NULL, '2024-01-25 17:00:00', '2026-07-25', TRUE, '2024-01-25 17:00:00'
FROM users u WHERE u.email = 'robert.ssemwanga@gmail.com';
...
SELECT gen_random_uuid(), u.user_id,
    850, 95.0, 'low', 98, 95, 10.0, 96,
    NULL, '2024-03-02 10:00:00', '2026-09-01', TRUE, '2024-03-02 10:00:00'
FROM users u WHERE u.email = 'invest@pearlcapital.ug';
...
SELECT gen_random_uuid(), u.user_id,
    845, 95.0, 'low', 96, 93, 12.0, 95,
    NULL, '2024-03-04 11:00:00', '2026-09-03', TRUE, '2024-03-04 11:00:00'
FROM users u WHERE u.email = 'funds@victoriainvest.co.ug';
...
SELECT gen_random_uuid(), u.user_id,
    580, 44.0, 'high', 48, 42, 45.0, 40,
    NULL, '2024-03-09 10:00:00', '2026-09-18', TRUE, '2024-03-09 10:00:00'
FROM users u WHERE u.email = 'frank.omondi@gmail.com';
...
SELECT gen_random_uuid(), u.user_id,
    690, 68.0, 'medium', 70, 65, 28.0, 65,
    NULL, '2024-03-11 12:00:00', '2026-09-11', TRUE, '2024-03-11 12:00:00'
FROM users u WHERE u.email = 'lucy.nambi@yahoo.com';
...
SELECT gen_random_uuid(), u.user_id,
    760, 82.0, 'low', 85, 80, 16.0, 80,
    NULL, '2024-03-13 16:00:00', '2026-09-13', TRUE, '2024-03-13 16:00:00'
FROM users u WHERE u.email = 'charles.mwesigwa@gmail.com';
...
-- trg_auto_create_wallet already created the rows.
-- We now set the opening lendable_balance for each
-- lender before inserting bids.
-- ============================================
...
SELECT gen_random_uuid(), lr.request_id, l.user_id,
    2000000.00, 11.0, 'pending', TRUE, '2025-11-15 12:30:00'
...
INSERT INTO bids (bid_id, request_id, lender_id, bid_amount, interest_rate, status, auto_accept, created_at)
SELECT gen_random_uuid(), lr.request_id, l.user_id,
    2000000.00, 11.5, 'pending', FALSE, '2025-11-16 09:15:00'
...
INSERT INTO bids (bid_id, request_id, lender_id, bid_amount, interest_rate, status, auto_accept, created_at)
SELECT gen_random_uuid(), lr.request_id, l.user_id,
    1000000.00, 12.0, 'pending', FALSE, '2025-11-18 08:45:00'
...
INSERT INTO bids (bid_id, request_id, lender_id, bid_amount, interest_rate, status, auto_accept, created_at)
SELECT gen_random_uuid(), lr.request_id, l.user_id,
    1500000.00, 14.5, 'pending', FALSE, '2026-01-21 11:20:00'
FROM loan_requests lr JOIN users l ON l.email = 'robert.ssemwanga@gmail.com'
...
INSERT INTO bids (bid_id, request_id, lender_id, bid_amount, interest_rate, status, auto_accept, created_at)
SELECT gen_random_uuid(), lr.request_id, l.user_id,
    1800000.00, 15.0, 'pending', FALSE, '2026-01-24 08:45:00'
...
SELECT gen_random_uuid(), lr.request_id, l.user_id,
    1000000.00, 15.0, 'pending', FALSE, '2026-01-26 14:20:00', '2026-02-02 14:20:00'
FROM loan_requests lr JOIN users l ON l.email = 'robert.ssemwanga@gmail.com'
WHERE lr.borrower_id = (SELECT user_id FROM users WHERE email = 'sarah.namukasa@yahoo.com') LIMIT 1;
...
INSERT INTO bids (bid_id, request_id, lender_id, bid_amount, interest_rate, status, auto_accept, created_at)
SELECT gen_random_uuid(), lr.request_id, l.user_id,
    5000000.00, 10.0, 'pending', TRUE, '2025-11-20 11:20:00'
FROM loan_requests lr JOIN users l ON l.email = 'invest@pearlcapital.ug'
...
INSERT INTO bids (bid_id, request_id, lender_id, bid_amount, interest_rate, status, auto_accept, created_at)
SELECT gen_random_uuid(), lr.request_id, l.user_id,
    3000000.00, 10.5, 'pending', TRUE, '2025-11-23 13:15:00'
...
INSERT INTO bids (bid_id, request_id, lender_id, bid_amount, interest_rate, status, auto_accept, created_at, expires_at)
SELECT gen_random_uuid(), lr.request_id, l.user_id,
    1500000.00, 14.0, 'pending', FALSE, '2026-01-27 10:30:00', '2026-02-03 10:30:00'
...
INSERT INTO bids (bid_id, request_id, lender_id, bid_amount, interest_rate, status, auto_accept, created_at, expires_at)
SELECT gen_random_uuid(), lr.request_id, l.user_id,
    2000000.00, 14.5, 'pending', FALSE, '2026-01-28 09:15:00', '2026-02-04 09:15:00'
...
-- UPDATE pending → accepted fires:
--   trg_fn_lock_funds_on_accept  → moves lendable → locked
--   trg_fn_update_funding_progress → updates loan status
-- ============================================
...
-- Auth sync check: every public.user should have an auth.users row
SELECT
    pu.email,
...
SELECT '✅ Seed data v2.0 inserted successfully' AS status;