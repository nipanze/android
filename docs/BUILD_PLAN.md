...
| 3.9 | Blocked Users & Request Visibility System | ✅ Complete | Database-enforced directional blocking (`user_blocks`), RLS policies & offer validation triggers preventing blocked users from seeing/interacting with future Loan or Forex requests, Account -> Privacy & Visibility -> Blocked Users management UI, 5-language ARB localization, disabled button state validation, and complete test suite |
| 3.95 | Language & Subscription Currency Separation | ✅ Complete | Uncoupled dynamic app language selection (English, Kiswahili, Français, Ikinyarwanda, العربية) from subscription currency; subscription currency is determined by registered phone number dial code (+256 -> UGX, +254 -> KES, +255 -> TZS, +250 -> RWF, etc.) and clearly displayed as locked/read-only in Account Settings |
