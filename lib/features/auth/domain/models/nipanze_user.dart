...
class NipanzeUser extends Equatable {
  ...
  bool get canBorrow => subscriptionPlan == SubscriptionPlan.borrower || subscriptionPlan == SubscriptionPlan.pro;
  bool get canLend => subscriptionPlan == SubscriptionPlan.lender || subscriptionPlan == SubscriptionPlan.pro;
  ...
  factory NipanzeUser.fromMap(Map<String, dynamic> map) {
    return NipanzeUser(
      ...
      repTier: _repTierFromString(map['reputation_tier'] as String? ?? 'bronze'),
      lenderToken: map['lender_token'] as String?,
      subscriptionPlan: _planFromString(map['subscription_plan'] as String? ?? 'watchlist'),
      kycStatus: _kycFromString(map['kyc_status'] as String? ?? 'not_submitted'),
  ...
  static SubscriptionPlan _planFromString(String s) {
    switch (s) {
      case 'borrower': return SubscriptionPlan.borrower;
      case 'lender': return SubscriptionPlan.lender;
      case 'pro': return SubscriptionPlan.pro;
      default: return SubscriptionPlan.watchlist;
    }
  }
  ...
  static KycStatus _kycFromString(String s) {
    switch (s) {
      ...
      case 'expired': return KycStatus.expired;
      default: return KycStatus.notSubmitted;
    }
  }

  @override
  List<Object?> get props => [id, email, repTier, subscriptionPlan, kycStatus, role];
}
