    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(padding: const EdgeInsets.all(16), child: Column(children: [
        ...
        Container(width: 64, height: 64, decoration: BoxDecoration(
          gradient: const LinearGradient(colors: [Color(0xFF1E40AF), Color(0xFF7C3AED)], begin: Alignment.topLeft, end: Alignment.bottomRight),
          borderRadius: BorderRadius.circular(32)),
          child: Center(child: Text(user?.fullName?.isNotEmpty == true ? user!.fullName![0].toUpperCase() : 'U',
...
class _Row extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) => Row(children: [
    Text(l, style: Theme.of(context).textTheme.bodyMedium), const Spacer(),
